...
{#if data.user}
	<div class="mb-8 flex items-center justify-between rounded-xl border bg-white p-6">
		<div>
...
{:else}
	<div class="mb-8 rounded-xl bg-zinc-100 p-6 text-center">
		...
		<a
			href="/register"
			class="inline-block rounded-md bg-zinc-900 px-6 py-2 font-medium text-white hover:bg-zinc-800"
			>S'inscrire</a
		>
	</div>
{/if}
