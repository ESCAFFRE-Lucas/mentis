...
<Card.Root class="transition-shadow duration-200 hover:shadow-md">
	...
	<Card.Footer class="flex gap-4 border-t pt-4 text-zinc-500">
		<button class="flex items-center gap-1.5 text-sm transition-colors hover:text-red-500">
		...
		<button class="flex items-center gap-1.5 text-sm transition-colors hover:text-blue-500">
			<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
				><path
					stroke-linecap="round"
					stroke-linejoin="round"
